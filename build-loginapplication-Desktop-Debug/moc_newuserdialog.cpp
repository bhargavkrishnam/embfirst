...
#include "../loginapplication/newuserdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_newuserDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 46, 21)
    ...
    "newuserDialog\0on_pushButton_register_clicked\0"
...
const QMetaObject newuserDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_newuserDialog.data,
      qt_meta_data_newuserDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_newuserDialog.stringdata))
